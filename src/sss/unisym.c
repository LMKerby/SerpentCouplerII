	    ...
	    double *v, double *w)
{
  ...
  CheckValue(FUNCTION_NAME, "u", "1", *u, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "v", "1", *v, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "w", "1", *w, -1.0, 1.0);
  ...
  CheckValue(FUNCTION_NAME, "u", "2", *u, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "v", "2", *v, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "w", "2", *w, -1.0, 1.0);
  ...
  CheckValue(FUNCTION_NAME, "u", "3", *u, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "v", "3", *v, -1.0, 1.0);
  CheckValue(FUNCTION_NAME, "w", "3", *w, -1.0, 1.0);
