...
/*****************************************************************************/
/*                                                                           */
/* serpent 2 (beta-version) : bufval.c                                       */
/*                                                                           */
/* Created:       2010/11/10 (JLe)                                           */
/* Last modified: 2014/02/25 (JLe)                                           */
/* Version:       2.1.18                                                     */
/*                                                                           */
/* Description: Returns the content of score buffer                          */
/*                                                                           */
...
#define FUNCTION_NAME "BufVal:"

/*****************************************************************************/

double BufVal(long ptr, ...)
{
  ...
  if ((long)RDB[DATA_BUF_REDUCED] == NO)
    Die(FUNCTION_NAME, "Scoring buffer is not reduced");

  /* Get value */

  val = BUF[loc0 + BUF_VAL];
