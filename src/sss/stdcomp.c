...
void StdComp(char *mat, char *id)
{
  ...
  sprintf(alias[i], " ");
  sprintf(comment[i], "1.4970");
  sprintf(src[i], "VTT (S. Penttila)");
  dens[i] = -6.560000E+00;
  comp[i][ 6] = -9.50000E-04;
  comp[i][14] = -5.30000E-03;
  comp[i][25] = -1.68000E-02;
  comp[i][16] = -1.00000E-05;
  comp[i][15] = -7.00000E-05;
  comp[i][24] = -1.50000E-01;
  comp[i][28] = -1.53000E-01;
  comp[i][42] = -1.18000E-02;
  comp[i][29] = -2.00000E-04;
  comp[i][13] = -5.00000E-04;
  comp[i][74] = -1.00000E-04;
  comp[i][23] = -2.00000E-04;
  comp[i][22] = -4.50000E-03;
  comp[i][27] = -3.00000E-04;
  comp[i][26] = -6.56270E-01;
  i++;
  ...
  for (n = 0; n < 112; n++)
    if (comp[i][n] != 0.0)
      {
	if (id == NULL)
	  fprintf(out, "%5ld  %1.5E\n", 1000*n, comp[i][n]);
	else
	  fprintf(out, "%5ld.%s  %1.5E\n", 1000*n, id, comp[i][n]);
      }
