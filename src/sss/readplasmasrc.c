	...
	case 2:
	  {
	    ...
	    */
		...
		WDB[loc2 + SRC_PLASMA_REA_XYB] = N_xyb;
		WDB[loc2 + SRC_PLASMA_REA_PTR_XB] = ptr_xb; 
		WDB[loc2 + SRC_PLASMA_REA_PTR_YB] = ptr_yb;
		WDB[loc2 + SRC_PLASMA_REA_PTR_P_XY] = ptr_p_iso;
		...
		WDB[loc2 + SRC_PLASMA_REA_PTR_PHI] = ptr_phi;
		WDB[loc2 + SRC_PLASMA_REA_PTR_P_PHI] = ptr_p_iso;
