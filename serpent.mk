...
SERPENT_DIR := $(CURDIR)/src/sss
SERPENT_SRC_DIR := $(CURDIR)/src/sss
SERPENT_INC_DIR := $(CURDIR)/include
serpent_LIB := $(SERPENT_INC_DIR)/libserpent-$(METHOD).la
serpent_APP := $(CURDIR)/serpent-$(METHOD)-dyn
