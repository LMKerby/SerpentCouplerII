	   ...
	   double spd, double g, long id)
{
  ...
  if ((long)RDB[part + PARTICLE_TYPE] == PARTICLE_TYPE_GAMMA)
      ...
      if (mat > VALID_PTR)
	{
      ...
      ColDet(part, mat, flx, 0.0, x, y, z, u, v, w, E, t, wgt, g, id);
  ...
  */
  ...
  if (mat > VALID_PTR)
	...
	{
	  /* Get value if not already calculated (implicit rr) */
	  ...
	  ScoreInterfacePower(fissE, wgt, x, y, z, 0.0, id);
	}
    }
  ...
  ScoreGC(flx, tot, capt, fiss, fissE, nsf, ela, sprod, mat, part, E, spd, 
	  wgt, g, id);
