/*****************************************************************************/
/*                                                                           */
/* serpent 2 (beta-version) : hexindirection.c                               */
/*                                                                           */
/* Created:       2015/03/27 (VVa)                                           */
/* Last modified: 2015/03/27 (VVa)                                           */
/* Version:       2.1.24                                                     */
/*                                                                           */
/* Description: "Rotates" a hexahedron so that the corner point with         */
/*              smallest index is in bottom left front corner                */
/*                                                                           */
...
#define FUNCTION_NAME "HexIndirection:"

/*****************************************************************************/

void HexIndirection(long *hex)
{
