...
#define DATA_PTR_TFB0                    71
#define DATA_PTR_IFC0                    72
#define DATA_PTR_DIV0                    74
#define DATA_PTR_MVOL0                   75
#define DATA_PTR_SYM0                    76
#define DATA_PTR_REP0                    77
#define DATA_PTR_TME0                    79
#define DATA_PTR_RIA0                    80
#define DATA_PTR_SIM0                    81
...
#define DATA_INI_FMASS                  384
#define DATA_INI_BURN_FMASS             385
#define DATA_TOT_FMASS                  386
#define DATA_TOT_BURN_FMASS             387
...
#define DATA_OMP_MAX_THREADS            520
#define DATA_PTR_OMP_HISTORY_COUNT      521
...
#define DATA_EVENT_RECORD_MODE          572
...
#define DATA_BURN_MATERIALS_FLAG        823
#define DATA_BURN_PREV_KEFF             824
#define DATA_BURN_PREV_DKEFF            825
...
#define DATA_USE_TFB                   1073
#define DATA_USE_DENSITY_FACTOR        1074
...
#define DATA_GC_REMXS_MULT             1090

/* Calculation of analog reaction rates */

#define DATA_ANA_RR_NCALC              1091
#define DATA_ANA_RR_PCALC              1092
...
#define DATA_SIMULATOR_DATA            1195
#define DATA_CAX_OUTPUT                1196
...
/* Block line number calculation (bottleneck when reading large inputs) */

#define DATA_NO_LINE_NUMBER_CALC       1250
...
#define DATA_SOL_REL_MAXPOP            1282
#define DATA_SOL_REL_FACT              1283

#define DATA_BURN_CI_TOLER             1283
...
#define DATA_LAST_GLOBAL_STAT          1321

/* Last value in data block */

#define DATA_LAST_VALUE                1330
...
#define RES_FWD_IMP_GEN_TIME            (DATA_LAST_VALUE + 71)
#define RES_FWD_IMP_LIFETIME            (DATA_LAST_VALUE + 72)
...
#define RES_ADJ_MEULEKAMP_BETA_EFF      (DATA_LAST_VALUE + 78)
#define RES_ADJ_MEULEKAMP_LAMBDA        (DATA_LAST_VALUE + 79)
#define RES_ADJ_NAUCHI_GEN_TIME         (DATA_LAST_VALUE + 80)
#define RES_ADJ_NAUCHI_LIFETIME         (DATA_LAST_VALUE + 81)
#define RES_ADJ_NAUCHI_BETA_EFF         (DATA_LAST_VALUE + 82)
#define RES_ADJ_NAUCHI_LAMBDA           (DATA_LAST_VALUE + 83)
#define RES_ADJ_IFP_GEN_TIME            (DATA_LAST_VALUE + 84)
#define RES_ADJ_IFP_LIFETIME            (DATA_LAST_VALUE + 85)
#define RES_ADJ_IFP_IMP_BETA_EFF        (DATA_LAST_VALUE + 86)
#define RES_ADJ_IFP_IMP_LAMBDA          (DATA_LAST_VALUE + 87)
#define RES_ADJ_IFP_ANA_BETA_EFF        (DATA_LAST_VALUE + 88)
#define RES_ADJ_IFP_ANA_LAMBDA          (DATA_LAST_VALUE + 89)
#define RES_ADJ_IFP_ROSSI_ALPHA         (DATA_LAST_VALUE + 90)
#define RES_ADJ_PERT_GEN_TIME           (DATA_LAST_VALUE + 91)
#define RES_ADJ_PERT_LIFETIME           (DATA_LAST_VALUE + 92)
#define RES_ADJ_PERT_BETA_EFF           (DATA_LAST_VALUE + 93)
#define RES_ADJ_PERT_ROSSI_ALPHA        (DATA_LAST_VALUE + 94)
...
#define RES_CPU_TIME_PROFILE            (DATA_LAST_VALUE + 131)
...
/* TODO: N‰it‰ nimi‰ pit‰‰ seriously j‰rkevˆitt‰‰ !!! */

#define MATERIAL_BLOCK_SIZE            (LIST_DATA_SIZE + PARAM_N_COMMON + 134)
...
#define MATERIAL_PTR_INLP_REA_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 22)
#define MATERIAL_PTR_PHOT_TOT_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 23)
#define MATERIAL_PTR_PHOT_HEAT_LIST    (LIST_DATA_SIZE + PARAM_N_COMMON + 24)
#define MATERIAL_PTR_TOT_URES_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 25)
#define MATERIAL_PTR_ABS_URES_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 26)
#define MATERIAL_PTR_ELA_URES_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 27)
#define MATERIAL_PTR_FISS_URES_LIST    (LIST_DATA_SIZE + PARAM_N_COMMON + 28)
#define MATERIAL_PTR_TMP_MAJORANT_LIST (LIST_DATA_SIZE + PARAM_N_COMMON + 29)
#define MATERIAL_PTR_TOTXS             (LIST_DATA_SIZE + PARAM_N_COMMON + 30)
#define MATERIAL_PTR_ELAXS             (LIST_DATA_SIZE + PARAM_N_COMMON + 31)
#define MATERIAL_PTR_ABSXS             (LIST_DATA_SIZE + PARAM_N_COMMON + 32)
#define MATERIAL_PTR_FISSXS            (LIST_DATA_SIZE + PARAM_N_COMMON + 33)
#define MATERIAL_PTR_INLPXS            (LIST_DATA_SIZE + PARAM_N_COMMON + 34)
#define MATERIAL_PTR_FISSE             (LIST_DATA_SIZE + PARAM_N_COMMON + 35)
#define MATERIAL_PTR_NSF               (LIST_DATA_SIZE + PARAM_N_COMMON + 36)
#define MATERIAL_PTR_TOTPHOTXS         (LIST_DATA_SIZE + PARAM_N_COMMON + 37)
#define MATERIAL_PTR_HEATPHOTXS        (LIST_DATA_SIZE + PARAM_N_COMMON + 38)
#define MATERIAL_PTR_TMP_MAJORANTXS    (LIST_DATA_SIZE + PARAM_N_COMMON + 39)
#define MATERIAL_MEM_SIZE              (LIST_DATA_SIZE + PARAM_N_COMMON + 40)
#define MATERIAL_TOT_DIV_MEM_SIZE      (LIST_DATA_SIZE + PARAM_N_COMMON + 41)
#define MATERIAL_PTR_SAB               (LIST_DATA_SIZE + PARAM_N_COMMON + 42)
#define MATERIAL_PTR_DEP_TRA_LIST      (LIST_DATA_SIZE + PARAM_N_COMMON + 43)
#define MATERIAL_PTR_DEP_FISS_LIST     (LIST_DATA_SIZE + PARAM_N_COMMON + 44)
#define MATERIAL_ACTIVITY              (LIST_DATA_SIZE + PARAM_N_COMMON + 45)
#define MATERIAL_PHOTON_SRC_RATE       (LIST_DATA_SIZE + PARAM_N_COMMON + 46)
#define MATERIAL_SFRATE                (LIST_DATA_SIZE + PARAM_N_COMMON + 47)
#define MATERIAL_DECAY_HEAT            (LIST_DATA_SIZE + PARAM_N_COMMON + 48)
#define MATERIAL_PTR_FLUX_SPEC         (LIST_DATA_SIZE + PARAM_N_COMMON + 49)
#define MATERIAL_PTR_FLUX_SPEC_SUM     (LIST_DATA_SIZE + PARAM_N_COMMON + 50)
#define MATERIAL_PTR_BURN_FLUX         (LIST_DATA_SIZE + PARAM_N_COMMON + 51)
#define MATERIAL_BURN_FLUX_PS1         (LIST_DATA_SIZE + PARAM_N_COMMON + 52)
#define MATERIAL_BURN_FLUX_BOS         (LIST_DATA_SIZE + PARAM_N_COMMON + 53)
#define MATERIAL_BURN_FLUX_EOS         (LIST_DATA_SIZE + PARAM_N_COMMON + 54)
#define MATERIAL_BURN_FLUX_SSA         (LIST_DATA_SIZE + PARAM_N_COMMON + 55)
#define MATERIAL_BURN_POW_PS1          (LIST_DATA_SIZE + PARAM_N_COMMON + 56)
#define MATERIAL_BURN_POW_BOS          (LIST_DATA_SIZE + PARAM_N_COMMON + 57)
#define MATERIAL_BURN_POW_EOS          (LIST_DATA_SIZE + PARAM_N_COMMON + 58)
#define MATERIAL_BURNUP                (LIST_DATA_SIZE + PARAM_N_COMMON + 59)
#define MATERIAL_OMP_ID                (LIST_DATA_SIZE + PARAM_N_COMMON + 60)
#define MATERIAL_MPI_ID                (LIST_DATA_SIZE + PARAM_N_COMMON + 61)
#define MATERIAL_PTR_DATA_BLOCK        (LIST_DATA_SIZE + PARAM_N_COMMON + 62)
#define MATERIAL_DATA_BLOCK_SIZE       (LIST_DATA_SIZE + PARAM_N_COMMON + 63)
#define MATERIAL_PTR_IFC               (LIST_DATA_SIZE + PARAM_N_COMMON + 64)
#define MATERIAL_PROC_IDX              (LIST_DATA_SIZE + PARAM_N_COMMON + 65)
#define MATERIAL_BURN_IDX              (LIST_DATA_SIZE + PARAM_N_COMMON + 66)
#define MATERIAL_PTR_GCU               (LIST_DATA_SIZE + PARAM_N_COMMON + 67)
#define MATERIAL_PTR_DIV               (LIST_DATA_SIZE + PARAM_N_COMMON + 68)
#define MATERIAL_DIV_TYPE              (LIST_DATA_SIZE + PARAM_N_COMMON + 69)
#define MATERIAL_DIV_PTR_PARENT        (LIST_DATA_SIZE + PARAM_N_COMMON + 70)
#define MATERIAL_DIV_N_TOT_ZONES       (LIST_DATA_SIZE + PARAM_N_COMMON + 71)
#define MATERIAL_DIV_N_SUB_ZONES       (LIST_DATA_SIZE + PARAM_N_COMMON + 72)
#define MATERIAL_DIV_N_ZONES           (LIST_DATA_SIZE + PARAM_N_COMMON + 73)
#define MATERIAL_DIV_ZONE_IDX          (LIST_DATA_SIZE + PARAM_N_COMMON + 74)
#define MATERIAL_BURN_PRINT_OUTPUT     (LIST_DATA_SIZE + PARAM_N_COMMON + 75)
#define MATERIAL_DT_MODE               (LIST_DATA_SIZE + PARAM_N_COMMON + 76)
#define MATERIAL_URES_EMIN             (LIST_DATA_SIZE + PARAM_N_COMMON + 77)
#define MATERIAL_URES_EMAX             (LIST_DATA_SIZE + PARAM_N_COMMON + 78)
#define MATERIAL_VOL_COUNT             (LIST_DATA_SIZE + PARAM_N_COMMON + 79)
#define MATERIAL_BURN_SORT_FLAG        (LIST_DATA_SIZE + PARAM_N_COMMON + 80)
#define MATERIAL_TFB_DF                (LIST_DATA_SIZE + PARAM_N_COMMON + 81)
#define MATERIAL_FMTX_IDX              (LIST_DATA_SIZE + PARAM_N_COMMON + 82)
#define MATERIAL_PTR_I135_ISO          (LIST_DATA_SIZE + PARAM_N_COMMON + 83)
#define MATERIAL_PTR_XE135_ISO         (LIST_DATA_SIZE + PARAM_N_COMMON + 84)
#define MATERIAL_PTR_PM149_ISO         (LIST_DATA_SIZE + PARAM_N_COMMON + 85)
#define MATERIAL_PTR_SM149_ISO         (LIST_DATA_SIZE + PARAM_N_COMMON + 86)
#define MATERIAL_PTR_I135_PROD_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 87)
#define MATERIAL_PTR_XE135_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 88)
#define MATERIAL_PTR_PM149_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 89)
#define MATERIAL_PTR_SM149_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 90)
#define MATERIAL_PTR_I135_ABS_RATE     (LIST_DATA_SIZE + PARAM_N_COMMON + 91)
#define MATERIAL_PTR_XE135_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 92)
#define MATERIAL_PTR_PM149_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 93)
#define MATERIAL_PTR_SM149_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 94)
#define MATERIAL_XENON_EQUIL_CALC      (LIST_DATA_SIZE + PARAM_N_COMMON + 95)
#define MATERIAL_SAMARIUM_EQUIL_CALC   (LIST_DATA_SIZE + PARAM_N_COMMON + 96)
#define MATERIAL_PTR_I135_CONC         (LIST_DATA_SIZE + PARAM_N_COMMON + 97)
#define MATERIAL_PTR_XE135_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 98)
#define MATERIAL_PTR_PM149_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 99)
#define MATERIAL_PTR_SM149_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 100)
#define MATERIAL_DEFAULT_PTR_LIB_ID    (LIST_DATA_SIZE + PARAM_N_COMMON + 101)
#define MATERIAL_DEFAULT_TMP           (LIST_DATA_SIZE + PARAM_N_COMMON + 102)
#define MATERIAL_DOPPLER_TEMP          (LIST_DATA_SIZE + PARAM_N_COMMON + 103)
#define MATERIAL_TMS_MODE              (LIST_DATA_SIZE + PARAM_N_COMMON + 104)
#define MATERIAL_TMS_TMIN              (LIST_DATA_SIZE + PARAM_N_COMMON + 105)
#define MATERIAL_TMS_TMAX              (LIST_DATA_SIZE + PARAM_N_COMMON + 106)
#define MATERIAL_USE_IFC               (LIST_DATA_SIZE + PARAM_N_COMMON + 107)
#define MATERIAL_PTR_NORM              (LIST_DATA_SIZE + PARAM_N_COMMON + 108)
#define MATERIAL_COEF_TEMP             (LIST_DATA_SIZE + PARAM_N_COMMON + 109)
#define MATERIAL_COEF_SAB              (LIST_DATA_SIZE + PARAM_N_COMMON + 110)
#define MATERIAL_PTR_DIRECT_REA_LIST   (LIST_DATA_SIZE + PARAM_N_COMMON + 111)
#define MATERIAL_BURN_FLUX_REL         (LIST_DATA_SIZE + PARAM_N_COMMON + 112)
#define MATERIAL_BURN_FLUX_AVE         (LIST_DATA_SIZE + PARAM_N_COMMON + 113)
#define MATERIAL_CI_BOS_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 114)
#define MATERIAL_CI_EOS_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 115)
#define MATERIAL_CI_AVE_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 116)
#define MATERIAL_CI_BOS_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 117)
#define MATERIAL_CI_EOS_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 118)
#define MATERIAL_CI_AVE_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 119)
#define MATERIAL_CI_IDE                (LIST_DATA_SIZE + PARAM_N_COMMON + 120)
#define MATERIAL_PTR_DETBIN            (LIST_DATA_SIZE + PARAM_N_COMMON + 121)
#define MATERIAL_PTR_INFLOW            (LIST_DATA_SIZE + PARAM_N_COMMON + 122)
#define MATERIAL_PTR_OUTFLOW           (LIST_DATA_SIZE + PARAM_N_COMMON + 123)
#define MATERIAL_FLOW_IDX              (LIST_DATA_SIZE + PARAM_N_COMMON + 124)
#define MATERIAL_FLOW_N                (LIST_DATA_SIZE + PARAM_N_COMMON + 125)
#define MATERIAL_FLOW_PTR_FIRST        (LIST_DATA_SIZE + PARAM_N_COMMON + 126)
#define MATERIAL_PTR_ORIG_NUC_COMP     (LIST_DATA_SIZE + PARAM_N_COMMON + 127)
#define MATERIAL_PTR_DECAY_SRC         (LIST_DATA_SIZE + PARAM_N_COMMON + 128)
#define MATERIAL_PHOTON_ATT_NE         (LIST_DATA_SIZE + PARAM_N_COMMON + 129)
#define MATERIAL_PTR_PHOTON_ATT_E      (LIST_DATA_SIZE + PARAM_N_COMMON + 130)
#define MATERIAL_PTR_PHOTON_ATT_F      (LIST_DATA_SIZE + PARAM_N_COMMON + 131)
#define MATERIAL_SAMPLED_PHOTON_SRC    (LIST_DATA_SIZE + PARAM_N_COMMON + 132)
#define MATERIAL_MAX_ADENS             (LIST_DATA_SIZE + PARAM_N_COMMON + 133)
...
#define NUCLIDE_PTR_SUM_ABSXS          (LIST_DATA_SIZE + 37)
#define NUCLIDE_PTR_ELAXS              (LIST_DATA_SIZE + 38)
#define NUCLIDE_PTR_FISSXS             (LIST_DATA_SIZE + 39)
#define NUCLIDE_PTR_NGAMMAXS           (LIST_DATA_SIZE + 40)
#define NUCLIDE_PTR_NGAMMAXS_ISO       (LIST_DATA_SIZE + 41)
#define NUCLIDE_PTR_PHOTON_INCOHEXS    (LIST_DATA_SIZE + 42)
#define NUCLIDE_PTR_PHOTON_COHEXS      (LIST_DATA_SIZE + 43)
#define NUCLIDE_PTR_PHOTON_PHOTOELXS   (LIST_DATA_SIZE + 44)
#define NUCLIDE_PTR_PHOTON_PAIRPRODXS  (LIST_DATA_SIZE + 45)
#define NUCLIDE_PTR_PHOTON_HEATPRODXS  (LIST_DATA_SIZE + 46)
#define NUCLIDE_PTR_SAMPLE_REA_LIST    (LIST_DATA_SIZE + 47)
#define NUCLIDE_URES_EMIN              (LIST_DATA_SIZE + 48)
#define NUCLIDE_URES_EMAX              (LIST_DATA_SIZE + 49)
#define NUCLIDE_PTR_URES_RND           (LIST_DATA_SIZE + 50)
#define NUCLIDE_PTR_MATRIX_IDX         (LIST_DATA_SIZE + 51)
#define NUCLIDE_MEMSIZE                (LIST_DATA_SIZE + 52)
#define NUCLIDE_PTR_PHOTON_LINE_SPEC   (LIST_DATA_SIZE + 53)
#define NUCLIDE_IDX                    (LIST_DATA_SIZE + 54)
#define NUCLIDE_INVENTORY_IDX          (LIST_DATA_SIZE + 55)
#define NUCLIDE_TMP_IDX                (LIST_DATA_SIZE + 56)
#define NUCLIDE_PTR_TOTFISS_REA        (LIST_DATA_SIZE + 57)
#define NUCLIDE_SPEC_ING_TOX           (LIST_DATA_SIZE + 58)
#define NUCLIDE_SPEC_INH_TOX           (LIST_DATA_SIZE + 59)
#define NUCLIDE_SPEC_PHOTON_I          (LIST_DATA_SIZE + 60)
...
#define NUCLIDE_PREV_COL_ER            (LIST_DATA_SIZE + 64)
#define NUCLIDE_MIN_AFRAC              (LIST_DATA_SIZE + 65)
#define NUCLIDE_MAX_AFRAC              (LIST_DATA_SIZE + 66)
#define NUCLIDE_URES_SAMPLING          (LIST_DATA_SIZE + 67)
#define NUCLIDE_PTR_PHOTON_DATA        (LIST_DATA_SIZE + 68)
#define NUCLIDE_URES_INT               (LIST_DATA_SIZE + 69)
#define NUCLIDE_TMP_ADENS              (LIST_DATA_SIZE + 70)
#define NUCLIDE_TOP_MASS               (LIST_DATA_SIZE + 71)
#define NUCLIDE_TOP_ACTIVITY           (LIST_DATA_SIZE + 72)
#define NUCLIDE_TOP_SF                 (LIST_DATA_SIZE + 73)
#define NUCLIDE_TOP_GSRC               (LIST_DATA_SIZE + 74)
#define NUCLIDE_TOP_DECAY_HEAT         (LIST_DATA_SIZE + 75)
#define NUCLIDE_TOP_ING_TOX            (LIST_DATA_SIZE + 76)
#define NUCLIDE_TOP_INH_TOX            (LIST_DATA_SIZE + 77)
#define NUCLIDE_TEMP                   (LIST_DATA_SIZE + 78)
#define NUCLIDE_XS_TEMP                (LIST_DATA_SIZE + 79)
#define NUCLIDE_MAJORANT_TEMP          (LIST_DATA_SIZE + 80)
#define NUCLIDE_TMS_MIN_TEMP           (LIST_DATA_SIZE + 81)
#define NUCLIDE_TMS_MAX_TEMP           (LIST_DATA_SIZE + 82)
#define NUCLIDE_DBRC_MAX_TEMP          (LIST_DATA_SIZE + 83)
#define NUCLIDE_PTR_SAB_NUC            (LIST_DATA_SIZE + 84)
#define NUCLIDE_BRA_TYPE               (LIST_DATA_SIZE + 85)
#define NUCLIDE_PTR_SAB                (LIST_DATA_SIZE + 86)
#define NUCLIDE_SAB_EMAX               (LIST_DATA_SIZE + 87)
...
#define REACTION_BLOCK_SIZE             (LIST_DATA_SIZE + 67)
...
#define REACTION_CACHE_OPTI_IDX         (LIST_DATA_SIZE + 61)
#define REACTION_PTR_TMP_MAJORANT       (LIST_DATA_SIZE + 62)
#define REACTION_PTR_0K_DATA            (LIST_DATA_SIZE + 63)
#define REACTION_PTR_BRA_STATE          (LIST_DATA_SIZE + 64)
#define REACTION_PTR_BRA_ISOMER         (LIST_DATA_SIZE + 65)
#define REACTION_PTR_MULT               (LIST_DATA_SIZE + 66)
...
#define PHOTON_DIST_BLOCK_SIZE        (LIST_DATA_SIZE + 59)

#define PHOTON_DIST_RAYL_N            (LIST_DATA_SIZE + 0)
#define PHOTON_DIST_RAYL_X2           (LIST_DATA_SIZE + 1)
#define PHOTON_DIST_RAYL_LX2          (LIST_DATA_SIZE + 2)
#define PHOTON_DIST_RAYL_FF2          (LIST_DATA_SIZE + 3)
#define PHOTON_DIST_RAYL_FF2INT       (LIST_DATA_SIZE + 4)
#define PHOTON_DIST_RAYL_C            (LIST_DATA_SIZE + 5)
#define PHOTON_DIST_MINC              (LIST_DATA_SIZE + 6)
#define PHOTON_DIST_PTR_VIC           (LIST_DATA_SIZE + 7)
#define PHOTON_DIST_PTR_INC_FF        (LIST_DATA_SIZE + 8)
...
#define PHOTON_DIST_N_UOCCUP          (LIST_DATA_SIZE + 12)
#define PHOTON_DIST_PTR_UOCCUP        (LIST_DATA_SIZE + 13)
#define PHOTON_DIST_N_INC_CP          (LIST_DATA_SIZE + 14)
#define PHOTON_DIST_PTR_INC_CPPZ      (LIST_DATA_SIZE + 15)
#define PHOTON_DIST_PTR_INC_CP        (LIST_DATA_SIZE + 16)
#define PHOTON_DIST_PTR_INC_CPINT     (LIST_DATA_SIZE + 17)
#define PHOTON_DIST_INC_PZMAX         (LIST_DATA_SIZE + 18)
#define PHOTON_DIST_PTR_UI            (LIST_DATA_SIZE + 19)
#define PHOTON_DIST_INC_PZMINIDX      (LIST_DATA_SIZE + 20)
#define PHOTON_DIST_PTR_INC_ELNCDF    (LIST_DATA_SIZE + 21)
#define PHOTON_DIST_PTR_INC_EXTA      (LIST_DATA_SIZE + 22)

#define PHOTON_DIST_PTR_PP_MDXSFC     (LIST_DATA_SIZE + 23)
#define PHOTON_DIST_PP_FC             (LIST_DATA_SIZE + 24)
#define PHOTON_DIST_PTR_PP_F0         (LIST_DATA_SIZE + 25)
#define PHOTON_DIST_PP_G0             (LIST_DATA_SIZE + 26)

#define PHOTON_DIST_N_PE_SS           (LIST_DATA_SIZE + 27)
#define PHOTON_DIST_PTR_PE_NXS        (LIST_DATA_SIZE + 28)
#define PHOTON_DIST_PTR_PE_EB         (LIST_DATA_SIZE + 29)
#define PHOTON_DIST_PTR_PE_SSE        (LIST_DATA_SIZE + 30)
#define PHOTON_DIST_PTR_PE_SSXS       (LIST_DATA_SIZE + 31)
#define PHOTON_DIST_PTR_PE_SSIDX      (LIST_DATA_SIZE + 32)
#define PHOTON_DIST_N_PE_TOT          (LIST_DATA_SIZE + 33)
#define PHOTON_DIST_PTR_PE_ETOT       (LIST_DATA_SIZE + 34)
#define PHOTON_DIST_PTR_PE_XSTOT      (LIST_DATA_SIZE + 35)

#define PHOTON_DIST_N_AR_NSS          (LIST_DATA_SIZE + 36)
#define PHOTON_DIST_PTR_AR_NTR        (LIST_DATA_SIZE + 37)
#define PHOTON_DIST_PTR_EBI           (LIST_DATA_SIZE + 38)
#define PHOTON_DIST_PTR_AR_ELN        (LIST_DATA_SIZE + 39)
#define PHOTON_DIST_PTR_AR_ETR        (LIST_DATA_SIZE + 40)
#define PHOTON_DIST_PTR_AR_FTR        (LIST_DATA_SIZE + 41)
#define PHOTON_DIST_PTR_AR_SUBI       (LIST_DATA_SIZE + 42)
#define PHOTON_DIST_PTR_AR_SUBJ       (LIST_DATA_SIZE + 43)
#define PHOTON_DIST_PTR_AR_SUBK       (LIST_DATA_SIZE + 44)
#define PHOTON_DIST_PTR_AR_D2IMAP     (LIST_DATA_SIZE + 45)
#define PHOTON_DIST_AR_MAXVAC         (LIST_DATA_SIZE + 46)
#define PHOTON_DIST_PTR_AR_ELNCDF     (LIST_DATA_SIZE + 47)

#define PHOTON_DIST_N_TTB_NE          (LIST_DATA_SIZE + 48)
#define PHOTON_DIST_PTR_TTB_E         (LIST_DATA_SIZE + 49)
#define PHOTON_DIST_PTR_TTB_LE        (LIST_DATA_SIZE + 50)
#define PHOTON_DIST_PTR_TTB_LYE       (LIST_DATA_SIZE + 51)
#define PHOTON_DIST_PTR_TTB_LYP       (LIST_DATA_SIZE + 52)
#define PHOTON_DIST_PTR_TTB_BRECDF    (LIST_DATA_SIZE + 53)
#define PHOTON_DIST_PTR_TTB_BRPCDF    (LIST_DATA_SIZE + 54)
#define PHOTON_DIST_PTR_TTB_BREPDF    (LIST_DATA_SIZE + 55)
#define PHOTON_DIST_PTR_TTB_BRPPDF    (LIST_DATA_SIZE + 56)

#define PHOTON_DIST_PTR_PE_E          (LIST_DATA_SIZE + 57)
#define PHOTON_DIST_PTR_PE_XSCDF      (LIST_DATA_SIZE + 58)
...
#define CELL_BLOCK_SIZE          (LIST_DATA_SIZE + PARAM_N_COMMON + 18)
...
#define NEST_REG_BLOCK_SIZE     (LIST_DATA_SIZE + 7)
...
#define IFC_FUEP_LIST_BLOCK_SIZE       (LIST_DATA_SIZE + 23)
...
#define IFC_FUEP_LIM_PTR_T             (LIST_DATA_SIZE + 22)

#define IFC_FUEP_T_BLOCK_SIZE          (LIST_DATA_SIZE + 16)
...
#define IFC_FUEP_FINIX_PTR_T           (LIST_DATA_SIZE + 4)
#define IFC_FUEP_FINIX_PTR_R           (LIST_DATA_SIZE + 5)
#define IFC_FUEP_FINIX_PTR_R_COLD      (LIST_DATA_SIZE + 6)
#define IFC_FUEP_FINIX_PTR_PDEN        (LIST_DATA_SIZE + 7)
#define IFC_FUEP_FINIX_PTR_BU          (LIST_DATA_SIZE + 8)
#define IFC_FUEP_FINIX_PTR_PARAMS      (LIST_DATA_SIZE + 9)
#define IFC_FUEP_FINIX_PTR_BCOND       (LIST_DATA_SIZE + 10)
#define IFC_FUEP_FINIX_PTR_SRESULTS    (LIST_DATA_SIZE + 11)
#define IFC_FUEP_FINIX_PTR_VRESULTS    (LIST_DATA_SIZE + 12)
#define IFC_FUEP_FINIX_PTR_OPTIONS     (LIST_DATA_SIZE + 13)
#define IFC_FUEP_FINIX_PTR_NNODES      (LIST_DATA_SIZE + 14)
#define IFC_FUEP_FINIX_PTR_LHR         (LIST_DATA_SIZE + 15)
...
#define SRC_BLOCK_SIZE                (LIST_DATA_SIZE + PARAM_N_COMMON + 36)
...
#define SRC_PLASMA_BLOCK_SIZE          (LIST_DATA_SIZE + 12)

#define SRC_PLASMA_X0                  (LIST_DATA_SIZE + 0)
#define SRC_PLASMA_Y0                  (LIST_DATA_SIZE + 1)
#define SRC_PLASMA_CO                  (LIST_DATA_SIZE + 2)
#define SRC_PLASMA_XYB                 (LIST_DATA_SIZE + 3)
#define SRC_PLASMA_PTR_XB              (LIST_DATA_SIZE + 4)
#define SRC_PLASMA_PTR_YB              (LIST_DATA_SIZE + 5)
#define SRC_PLASMA_N_ISO               (LIST_DATA_SIZE + 6)
#define SRC_PLASMA_PTR_PHI             (LIST_DATA_SIZE + 7)
#define SRC_PLASMA_PTR_P_ISO           (LIST_DATA_SIZE + 8)
#define SRC_PLASMA_REACTIONS           (LIST_DATA_SIZE + 9)
#define SRC_PLASMA_PTR_REACT           (LIST_DATA_SIZE + 10)
#define SRC_PLASMA_DATA_SIZE           (LIST_DATA_SIZE + 11)
...
#define DET_BLOCK_SIZE                (LIST_DATA_SIZE + PARAM_N_COMMON + 36)
...
#define DET_RBIN_BLOCK_SIZE           (LIST_DATA_SIZE + 9)
...
#define DET_RBIN_USDEF_INTT           (LIST_DATA_SIZE + 4)
#define DET_RBIN_USDEF_NP             (LIST_DATA_SIZE + 5)
#define DET_RBIN_USDEF_PTR_E          (LIST_DATA_SIZE + 6)
#define DET_RBIN_USDEF_PTR_F          (LIST_DATA_SIZE + 7)
...
#define PARTICLE_BLOCK_SIZE       (LIST_DATA_SIZE + 36)
...
#define EVENT_BLOCK_SIZE          (LIFO_LIST_DATA_SIZE + 7)
...
#define TFB_REG_TMS_TMIN        (LIST_DATA_SIZE + 2)
#define TFB_REG_TMS_TMAX        (LIST_DATA_SIZE + 3)
...
/* N‰‰ voisi olla header.h:ssa? */

#define TFB_MODE_FINIX                  4

#define FINIX_BCTYPE_CLADT              0
#define FINIX_BCTYPE_HFLUX              1
#define FINIX_BCTYPE_HTCOE              2
#define FINIX_BCTYPE_COOLT              3

#define FINIX_RODTYPE_TMI1              0

/* FINIX block */

#define FINIX_BLOCK_SIZE            (LIST_DATA_SIZE + PARAM_N_COMMON  +  37)
...
#define FINIX_PTR_NNODES            (LIST_DATA_SIZE + PARAM_N_COMMON  +  14)
#define FINIX_PTR_T                 (LIST_DATA_SIZE + PARAM_N_COMMON  +  15)
#define FINIX_PTR_R                 (LIST_DATA_SIZE + PARAM_N_COMMON  +  16)
#define FINIX_PTR_R_COLD            (LIST_DATA_SIZE + PARAM_N_COMMON  +  17)
...
#define FINIX_PTR_FNAME             (LIST_DATA_SIZE + PARAM_N_COMMON  +  36)
...
#define MESH_BLOCK_SIZE         (LIST_DATA_SIZE + 20)
...
#define MESH_PTR_PTR            (LIST_DATA_SIZE + 13)
#define MESH_ORTHO_PTR_XLIM     (LIST_DATA_SIZE + 14)
#define MESH_ORTHO_PTR_YLIM     (LIST_DATA_SIZE + 15)
#define MESH_ORTHO_PTR_ZLIM     (LIST_DATA_SIZE + 16)
#define MESH_ADA_SPLIT          (LIST_DATA_SIZE + 17)
#define MESH_ADA_PTR_SZ         (LIST_DATA_SIZE + 18)
#define MESH_LOCAL_COORDS       (LIST_DATA_SIZE + 19)
...
#define DIV_BLOCK_SIZE           (LIST_DATA_SIZE + PARAM_N_COMMON + 14)
...
#define DIV_SEP_LVL              (LIST_DATA_SIZE + PARAM_N_COMMON + 10)
#define DIV_PTR_MAT_LIST         (LIST_DATA_SIZE + PARAM_N_COMMON + 11)
#define DIV_OUTPUT_FLAG          (LIST_DATA_SIZE + PARAM_N_COMMON + 12)
#define DIV_LVL_MAX              (LIST_DATA_SIZE + PARAM_N_COMMON + 13)
...
/* These are obsolete Serpent 1 style constants, kept in the source code */
/* until final cleanup */

#define GCU_RES_FG_FLX                 (LIST_DATA_SIZE +  3)
#define GCU_RES_FG_LEAK                (LIST_DATA_SIZE +  4)
#define GCU_RES_FG_TOTXS               (LIST_DATA_SIZE +  5)
#define GCU_RES_FG_FISSXS              (LIST_DATA_SIZE +  6)
#define GCU_RES_FG_CAPTXS              (LIST_DATA_SIZE +  7)
#define GCU_RES_FG_ABSXS               (LIST_DATA_SIZE +  8)
#define GCU_RES_FG_RABSXS              (LIST_DATA_SIZE +  9)
#define GCU_RES_FG_ELAXS               (LIST_DATA_SIZE + 10)
#define GCU_RES_FG_INLXS               (LIST_DATA_SIZE + 11)
#define GCU_RES_FG_SCATTXS             (LIST_DATA_SIZE + 12)
#define GCU_RES_FG_SCATTPRODXS         (LIST_DATA_SIZE + 13)
#define GCU_RES_FG_REMXS               (LIST_DATA_SIZE + 14)
#define GCU_RES_FG_NUBAR               (LIST_DATA_SIZE + 15)
#define GCU_RES_FG_NSF                 (LIST_DATA_SIZE + 16)
#define GCU_RES_FG_RECIPVEL            (LIST_DATA_SIZE + 17)
#define GCU_RES_FG_FISSE               (LIST_DATA_SIZE + 18)
#define GCU_RES_FG_CHI                 (LIST_DATA_SIZE + 19)
#define GCU_RES_FG_CHIP                (LIST_DATA_SIZE + 20)
#define GCU_RES_FG_CHID                (LIST_DATA_SIZE + 21)
#define GCU_RES_FG_GTRANSP             (LIST_DATA_SIZE + 22)
#define GCU_RES_FG_GTRANSXS            (LIST_DATA_SIZE + 23)
#define GCU_RES_FG_GPRODP              (LIST_DATA_SIZE + 24)
#define GCU_RES_FG_GPRODXS             (LIST_DATA_SIZE + 25)
#define GCU_RES_FG_SCATT0              (LIST_DATA_SIZE + 26)
#define GCU_RES_FG_SCATT1              (LIST_DATA_SIZE + 27)
#define GCU_RES_FG_SCATT2              (LIST_DATA_SIZE + 28)
#define GCU_RES_FG_SCATT3              (LIST_DATA_SIZE + 29)
#define GCU_RES_FG_SCATT4              (LIST_DATA_SIZE + 30)
#define GCU_RES_FG_SCATT5              (LIST_DATA_SIZE + 31)
#define GCU_RES_FG_I135_PROD_XS        (LIST_DATA_SIZE + 32)
#define GCU_RES_FG_XE135_PROD_XS       (LIST_DATA_SIZE + 33)
#define GCU_RES_FG_PM149_PROD_XS       (LIST_DATA_SIZE + 34)
#define GCU_RES_FG_SM149_PROD_XS       (LIST_DATA_SIZE + 35)
#define GCU_RES_FG_I135_ABS_XS         (LIST_DATA_SIZE + 36)
#define GCU_RES_FG_XE135_ABS_XS        (LIST_DATA_SIZE + 37)
#define GCU_RES_FG_PM149_ABS_XS        (LIST_DATA_SIZE + 38)
#define GCU_RES_FG_SM149_ABS_XS        (LIST_DATA_SIZE + 39)
...
#define GCU_FUM_PTR_SPEC_CORR          (LIST_DATA_SIZE + 45)
#define GCU_FUM_FG_B1_KINF             (LIST_DATA_SIZE + 46)
#define GCU_FUM_FG_B1_BUCKLING         (LIST_DATA_SIZE + 47)
#define GCU_FUM_FG_B1_DIFFCOEF         (LIST_DATA_SIZE + 48)
#define GCU_FUM_FG_B1_ABSXS            (LIST_DATA_SIZE + 49)
#define GCU_FUM_FG_B1_RABSXS           (LIST_DATA_SIZE + 50)
#define GCU_FUM_FG_B1_NSF              (LIST_DATA_SIZE + 51)
#define GCU_FUM_FG_B1_FISSXS           (LIST_DATA_SIZE + 52)
#define GCU_FUM_FG_B1_SCATTXS          (LIST_DATA_SIZE + 53)
#define GCU_FUM_FG_B1_SCATTPRODXS      (LIST_DATA_SIZE + 54)
#define GCU_FUM_FG_B1_TOTXS            (LIST_DATA_SIZE + 55)
#define GCU_FUM_FG_B1_FLUX             (LIST_DATA_SIZE + 56)
#define GCU_FUM_FG_B1_CHI              (LIST_DATA_SIZE + 57)
#define GCU_FUM_FG_B1_REMXS            (LIST_DATA_SIZE + 58)
#define GCU_FUM_FG_I135_PROD_XS        (LIST_DATA_SIZE + 59)
#define GCU_FUM_FG_XE135_PROD_XS       (LIST_DATA_SIZE + 60)
#define GCU_FUM_FG_PM149_PROD_XS       (LIST_DATA_SIZE + 61)
#define GCU_FUM_FG_SM149_PROD_XS       (LIST_DATA_SIZE + 62)
#define GCU_FUM_FG_I135_ABS_XS         (LIST_DATA_SIZE + 63)
#define GCU_FUM_FG_XE135_ABS_XS        (LIST_DATA_SIZE + 64)
#define GCU_FUM_FG_PM149_ABS_XS        (LIST_DATA_SIZE + 65)
#define GCU_FUM_FG_SM149_ABS_XS        (LIST_DATA_SIZE + 66)

#endif

/* T‰‰ varmaan myˆhemmin pois */

#define GCU_PTR_MORA                   (LIST_DATA_SIZE + 67)

/* Discontinuity factors, etc. */

#define GCU_RES_FG_DF_HET_SURF_FLUX    (LIST_DATA_SIZE + 68)
#define GCU_RES_FG_DF_HET_CORN_FLUX    (LIST_DATA_SIZE + 69)
#define GCU_RES_FG_DF_HET_VOL_FLUX     (LIST_DATA_SIZE + 70)
#define GCU_RES_FG_DF_SURF_DF          (LIST_DATA_SIZE + 71)
#define GCU_RES_FG_DF_CORN_DF          (LIST_DATA_SIZE + 72)
#define GCU_RES_FG_DF_SURF_IN_CURR     (LIST_DATA_SIZE + 73)
#define GCU_RES_FG_DF_SURF_OUT_CURR    (LIST_DATA_SIZE + 74)
#define GCU_RES_FG_DF_SURF_NET_CURR    (LIST_DATA_SIZE + 75)
#define GCU_RES_FG_DF_MID_IN_CURR      (LIST_DATA_SIZE + 76)
#define GCU_RES_FG_DF_MID_OUT_CURR     (LIST_DATA_SIZE + 77)
#define GCU_RES_FG_DF_MID_NET_CURR     (LIST_DATA_SIZE + 78)
#define GCU_RES_FG_DF_CORN_IN_CURR     (LIST_DATA_SIZE + 79)
#define GCU_RES_FG_DF_CORN_OUT_CURR    (LIST_DATA_SIZE + 80)
#define GCU_RES_FG_DF_CORN_NET_CURR    (LIST_DATA_SIZE + 81)
#define GCU_RES_FG_DF_HOM_SURF_FLUX    (LIST_DATA_SIZE + 82)
#define GCU_RES_FG_DF_HOM_CORN_FLUX    (LIST_DATA_SIZE + 83)
#define GCU_RES_FG_DF_HOM_VOL_FLUX     (LIST_DATA_SIZE + 84)

/* Diffusion coefficient for E.D */

#define GCU_RES_DIFFCOEF_ED            (LIST_DATA_SIZE + 87)

/* Pin-power distributions */

#define GCU_PTR_PPW                    (LIST_DATA_SIZE + 88)
#define GCU_RES_FG_PPW_POW             (LIST_DATA_SIZE + 89)
#define GCU_RES_FG_PPW_HOM_FLUX        (LIST_DATA_SIZE + 90)
#define GCU_RES_FG_PPW_FF              (LIST_DATA_SIZE + 91)
#define GCU_RES_FG_PPW_XYZ             (LIST_DATA_SIZE + 92)

/* Albedos */

#define GCU_PTR_ALB                    (LIST_DATA_SIZE + 93)
#define GCU_RES_FG_ALB_IN_CURR         (LIST_DATA_SIZE + 94)
#define GCU_RES_FG_ALB_OUT_CURR        (LIST_DATA_SIZE + 95)
#define GCU_RES_FG_TOT_ALB             (LIST_DATA_SIZE + 96)
#define GCU_RES_FG_PART_ALB            (LIST_DATA_SIZE + 97)
...
#define GCU_MICRO_ADF_SURF_IN_CURR     (LIST_DATA_SIZE + 142)
#define GCU_MICRO_ADF_SURF_OUT_CURR    (LIST_DATA_SIZE + 143)
#define GCU_MICRO_ADF_MID_IN_CURR      (LIST_DATA_SIZE + 144)
#define GCU_MICRO_ADF_MID_OUT_CURR     (LIST_DATA_SIZE + 145)
#define GCU_MICRO_ADF_CORN_IN_CURR     (LIST_DATA_SIZE + 146)
#define GCU_MICRO_ADF_CORN_OUT_CURR    (LIST_DATA_SIZE + 147)
#define GCU_MICRO_B1_FLX               (LIST_DATA_SIZE + 148)
#define GCU_MICRO_B1_DIFFCOEF          (LIST_DATA_SIZE + 149)
#define GCU_MICRO_DIFFCOEF_ED          (LIST_DATA_SIZE + 150)
#define GCU_MICRO_PPW_POW              (LIST_DATA_SIZE + 151)
#define GCU_MICRO_PPW_XYZ              (LIST_DATA_SIZE + 152)
#define GCU_MICRO_ALB_IN_CURR          (LIST_DATA_SIZE + 153)
#define GCU_MICRO_ALB_OUT_CURR         (LIST_DATA_SIZE + 154)
...
#define GCU_MEULEKAMP_TOT_FISS         (LIST_DATA_SIZE + 360)
#define GCU_MEULEKAMP_BETA_EFF         (LIST_DATA_SIZE + 361)
#define GCU_MEULEKAMP_LAMBDA           (LIST_DATA_SIZE + 362)

#define GCU_PTR_FIRST_STAT             (LIST_DATA_SIZE + 363)
#define GCU_PTR_LAST_STAT              (LIST_DATA_SIZE + 364)
...
#define DEP_BRA_BLOCK_SIZE              (LIST_DATA_SIZE + PARAM_N_COMMON + 7)
...
#define DEP_BRA_STP_SAB_BLOCK_SIZE      (LIST_DATA_SIZE + 2)

#define DEP_BRA_STP_SAB_PTR_LIB         (LIST_DATA_SIZE + 0)
#define DEP_BRA_STP_SAB_ZA              (LIST_DATA_SIZE + 1)
...
#define DEP_BRA_TRANS_PTR_TRANS1        (LIST_DATA_SIZE + 0)
#define DEP_BRA_TRANS_PTR_TRANS2        (LIST_DATA_SIZE + 1)
