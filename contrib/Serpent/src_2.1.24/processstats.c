...
void ProcessStats()
{
  ...
  ptr = NewStat("CPU_TIME_PROFILE", 1, 3);
  WDB[RES_CPU_TIME_PROFILE] = (double)ptr;  
  ...
  ptr = NewStat("FWD_IMP_GEN_TIME", 1, 1);
  WDB[RES_FWD_IMP_GEN_TIME] = (double)ptr;  

  ptr = NewStat("FWD_IMP_LIFETIME", 1, 1);
  WDB[RES_FWD_IMP_LIFETIME] = (double)ptr;  
