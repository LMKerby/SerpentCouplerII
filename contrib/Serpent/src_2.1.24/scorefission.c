...
{
  long ptr, gcu, ntot, ng, nuc, ncol, tfb, nst, reg, i, loc0, tb, fmx, uni;
  long norm;
  double fE;
	  ...
	  if ((ng = GridSearch(ptr, E1)) > -1)
	    {
	      ...
	      AddBuf1D(wgt1, wgt0, ptr, id, ntot - ng - 1);
