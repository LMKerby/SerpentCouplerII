...
void MicroCalc()
{
  ...
  const double *Xep, *Ip, *Smp, *Pmp, *Ia, *Xea, *Pma, *Sma, *Iam, *Xeam;
  const double *Pmam, *Smam, *ppc, *ppp;
	  ...
	  if ((long)RDB[DATA_OPTI_POISON_CALC] == YES)
	    {
	      ...
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx0[n]*fiss[n]*Pmp[n], 1.0, ptr, 0, i);
	      ...
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx0[n]*fflx[n]*Pma[n], 1.0, ptr, 0, i);
	      ...
	      /* Macroscopic I-135 absorption */

	      ptr = (long)RDB[gcu + GCU_INF_I135_MACRO_ABS];
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx0[n]*Iam[n], 1.0, ptr, 0, i);
	      ...
	      /* Macroscopic  Pm-149 absorption */

	      ptr = (long)RDB[gcu + GCU_INF_PM149_MACRO_ABS];
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx0[n]*Pmam[n], 1.0, ptr, 0, i);
	  ...
	  if ((long)RDB[DATA_OPTI_POISON_CALC] == YES)
	    {
	      ...
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx1[n]*fiss[n]*Pmp[n], 1.0, ptr, 0, i);
	      ...
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx1[n]*fflx[n]*Pma[n], 1.0, ptr, 0, i);
	      ...
	      ptr = (long)RDB[gcu + GCU_B1_I135_MACRO_ABS];
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx1[n]*Iam[n], 1.0, ptr, 0, i);
	      ...
	      ptr = (long)RDB[gcu + GCU_B1_PM149_MACRO_ABS];
	      CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);	  
	      AddBuf1D(flx1[n]*Pmam[n], 1.0, ptr, 0, i);
