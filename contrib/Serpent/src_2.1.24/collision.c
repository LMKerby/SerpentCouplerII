	       ...
	       double *v, double *w, double *E, double *wgt, double t, long id)
{
  ...
  double totxs, absxs, E0, u0, v0, w0, mu, wgt0, wgt1, wgt2;
  ...
  if (type == PARTICLE_TYPE_NEUTRON)
      ...
      else if (fabs(RDB[rea + REACTION_TY]) > 100.0)
	{
	  ...
	  ComplexRea(rea, E, u, v, w, wgt1, &wgt2, id);
      ...
      else if (RDB[rea + REACTION_WGT_F] > 1.0)
	{
	  ...
	  Nxn(rea, part, E, x, y, z, u, v, w, wgt1, &wgt2, t, id);
      ...
      if (mt == 504)
	{
	  ...
	  ComptonScattering(rea, part, E, x, y, z, u, v, w, *wgt, t, id);
      ...
      else if (mt == 522)
	{
	  ...
	  Photoelectric(rea, part, *E, x, y, z, *u, *v, *w, *wgt, t, id);
      ...
      else if (mt == 516)
	{
	  ...
	  PairProduction(rea, part, *E, x, y, z, *u, *v, *w, *wgt, t, id);
  ...
  if (type == PARTICLE_TYPE_NEUTRON)
	...
	*E = 0.999999*RDB[DATA_NEUTRON_EMAX];
      ...
      if (scatt == YES)
	{
	  ...
	  ColDet(part, mat, 0.0, E0 - *E, x, y, z, u0, v0, w0, E0, t, wgt1, 
		 1.0, id);

	  /* Score mesh */

	  ScoreMesh(part, mat, 0.0, E0 - *E, x, y, z, E0, t, wgt1, 1.0, id);
	}
