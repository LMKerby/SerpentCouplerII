...
void PairProduction(long rea, long part, double E, double x, double y,
		    ...
		    double t, long id)
{
  ...
  double E2, eps, eps2, epsmin, epsmax, tepsmin, stepsmin, xseps, xsepsmax,
      ...
      mup, ue, ve, we, up, vp, wp, u, v, w, sine2, a, b;
  ...
  /* Initialize electron direction cosines and rotate them */
  ue = u0;
  ve = v0;
  we = w0;
  ...
  TTB(rea, part, Ep, x, y, z, up, vp, wp, wgt, t, 1, id);
