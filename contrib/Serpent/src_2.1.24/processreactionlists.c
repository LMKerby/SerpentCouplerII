...
void ProcessReactionLists()
{
  ...
  fprintf(out, "Calculating maximum densities...\n");
  ...
  fprintf(out, "Performing density cut-off...\n");
      ...
      while (mat > VALID_PTR)
	{
	  ...
	  if ((mat0 = (long)RDB[mat + MATERIAL_DIV_PTR_PARENT]) > VALID_PTR)
	    {
	      ...
	      WDB[mat + MATERIAL_URES_EMIN] = WDB[mat0 + MATERIAL_URES_EMIN];
	      WDB[mat + MATERIAL_URES_EMAX] = WDB[mat0 + MATERIAL_URES_EMAX];
	    }
	  ...
	  for (n = 0; n < 6; n++)
		...
		continue;
	      ...
	      WDB[rea + REACTION_URES_EMIN] = RDB[mat + MATERIAL_URES_EMIN];
	      WDB[rea + REACTION_URES_EMAX] = RDB[mat + MATERIAL_URES_EMAX];
	    }
  ...
  fprintf(out, "Sorting material-wise reaction lists:\n\n");
