...
#define CODE_VERSION  "2.1.24"
#define CODE_DATE     "June 25, 2015"
...
#define E_CHECK_MAX  220.0  /* Maximum energy (used for checking) */
...
#define EVENT_TYPE_FISS  12

/* Event record modes */

#define EVENT_MODE_NONE   0
#define EVENT_MODE_IFP    1
#define EVENT_MODE_ALL    2
...
/* Face indices for hexahedrons (näissä vois olla HEX_ alussa, tms. */
...
double AtomicRelaxation(long, long, long, double, double, double, double, double, long);
...
void ComplexRea(long, double *, double *, double *, double *, double, double *,
		long);
...
void ComptonScattering(long, long, double *, double, double, double, double *,
		       double *, double *, double, double, long);
...
void dfSolver(long, long, long, double, double, double **, double **,
...
void DivideHexCell(long, long, long [8], long (*)[8], long (*)[6], 
		   long [6], long [6], long *, long *, long *);
...
void HexConnectDiags(long [8], long (*)[8]);

void HexFromCGNS(long, long, long *, long *, long *, long (*)[6], 
		 long (*)[4], long *, long *);

void HexGetFace(long[8], long *, long);

void HexGetFacePos(long *, long);

void HexIndirection(long*);
...
void HexRotateFace(long *, long);

void HexRotateLists(long [8], long (*)[4], long *, long *, long (*)[6]);
...
void PairProduction(long, long, double, double, double, double, double,
		    double, double, double, double, long);
...
void ProcessRelaxation(long, long);
...
long TrackMode(long, long, double, double, long, long);
