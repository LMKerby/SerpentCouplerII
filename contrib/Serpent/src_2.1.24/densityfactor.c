...
double DensityFactor(long mat, double x, double y, double z, double t, long id)
{
  ...
  /* Check TFB density factor */

  if ((f = RDB[mat + MATERIAL_TFB_DF]) > 0.0)
    {
      /* Check value */
  ...
  /* Check value (määrittelemättömät arvot asetetaan nyt nollaksi */
  /* pupuesimerkkiä varten JLE 14.11.2013) */
