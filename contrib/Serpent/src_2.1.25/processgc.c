  ...
  while (gcu > VALID_PTR)
    {
      ...
      /***** Old Serpent 1 style group constants *****************************/
      ...
      if ((long)RDB[DATA_B1_CALC] == YES)
	{
      ...
      /***** Micro-group data for new method *********************************/
      ...
      if ((long)RDB[DATA_OPTI_POISON_CALC] == YES)
	{
      ...
      ptr = NewStat("INF_I135_MACRO_ABS", 1, nfg - 1);
      ...
      ptr = NewStat("INF_PM149_MACRO_ABS", 1, nfg - 1);
      ...
      ptr = NewStat("B1_I135_MACRO_ABS", 1, nfg - 1);
      ...
      ptr = NewStat("B1_PM149_MACRO_ABS", 1, nfg - 1);
