...
void BurnMaterialsMSR(long mat, long step, long nss, long type, long mode)
{
  ...
  PrintDepMatrixMSR(mat, A, t2 - t1, N0, N0, sz + 1, id);
  ...
  */
  ...
  PrintDepMatrixMSR(mat, A, t2 - t1, N0, N, sz + 1, id); 
