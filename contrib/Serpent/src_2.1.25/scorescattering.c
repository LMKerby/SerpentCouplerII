		     ...
		     double wgt1, double wgt2, long id)
{
  ...
  while (gcu > VALID_PTR)
      ...
      if ((ng0 > -1) && (ng1 > -1))
	{
	  ...
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf(1.0, wgt1, ptr, id, -1, ntot - ng1 - 1, ntot - ng0 - 1);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_GPRODXS];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf(wgt2/wgt1, wgt1, ptr, id, -1, ntot - ng1 - 1, ntot - ng0 - 1);
	}
      ...
      if (ng0 > -1)
	{
	  ...
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P0, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P0, wgt1, ptr, id, 0);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_SCATT1];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P1, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P1, wgt1, ptr, id, 0);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_SCATT2];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P2, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P2, wgt1, ptr, id, 0);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_SCATT3];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P3, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P3, wgt1, ptr, id, 0);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_SCATT4];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P4, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P4, wgt1, ptr, id, 0);
	  
	  ptr = (long)RDB[gcu + GCU_RES_FG_SCATT5];
	  CheckPointer(FUNCTION_NAME, "(ptr)", DATA_ARRAY, ptr);
	  AddBuf1D(P5, wgt1, ptr, id, ntot - ng0);
	  AddBuf1D(P5, wgt1, ptr, id, 0);
	}
