...
#define DATA_PTR_PRIVA_HIS_IDX          522
...
#define DATA_LAST_GLOBAL_STAT          1332
...
#define MATERIAL_BLOCK_SIZE            (LIST_DATA_SIZE + PARAM_N_COMMON + 139)
...
#define MATERIAL_PTR_PM149_ISO         (LIST_DATA_SIZE + PARAM_N_COMMON + 90)
#define MATERIAL_PTR_SM149_ISO         (LIST_DATA_SIZE + PARAM_N_COMMON + 91)
#define MATERIAL_PTR_I135_PROD_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 92)
#define MATERIAL_PTR_XE135_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 93)
#define MATERIAL_PTR_PM149_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 94)
#define MATERIAL_PTR_SM149_PROD_RATE   (LIST_DATA_SIZE + PARAM_N_COMMON + 95)
#define MATERIAL_PTR_I135_ABS_RATE     (LIST_DATA_SIZE + PARAM_N_COMMON + 96)
#define MATERIAL_PTR_XE135_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 97)
#define MATERIAL_PTR_PM149_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 98)
#define MATERIAL_PTR_SM149_ABS_RATE    (LIST_DATA_SIZE + PARAM_N_COMMON + 99)
#define MATERIAL_XENON_EQUIL_CALC      (LIST_DATA_SIZE + PARAM_N_COMMON + 100)
#define MATERIAL_SAMARIUM_EQUIL_CALC   (LIST_DATA_SIZE + PARAM_N_COMMON + 101)
#define MATERIAL_PTR_I135_CONC         (LIST_DATA_SIZE + PARAM_N_COMMON + 102)
#define MATERIAL_PTR_XE135_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 103)
#define MATERIAL_PTR_PM149_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 104)
#define MATERIAL_PTR_SM149_CONC        (LIST_DATA_SIZE + PARAM_N_COMMON + 105)
#define MATERIAL_DEFAULT_PTR_LIB_ID    (LIST_DATA_SIZE + PARAM_N_COMMON + 106)
#define MATERIAL_DEFAULT_TMP           (LIST_DATA_SIZE + PARAM_N_COMMON + 107)
#define MATERIAL_DOPPLER_TEMP          (LIST_DATA_SIZE + PARAM_N_COMMON + 108)
#define MATERIAL_TMS_MODE              (LIST_DATA_SIZE + PARAM_N_COMMON + 109)
#define MATERIAL_TMS_TMIN              (LIST_DATA_SIZE + PARAM_N_COMMON + 110)
#define MATERIAL_TMS_TMAX              (LIST_DATA_SIZE + PARAM_N_COMMON + 111)
#define MATERIAL_USE_IFC               (LIST_DATA_SIZE + PARAM_N_COMMON + 112)
#define MATERIAL_PTR_NORM              (LIST_DATA_SIZE + PARAM_N_COMMON + 113)
#define MATERIAL_COEF_TEMP             (LIST_DATA_SIZE + PARAM_N_COMMON + 114)
#define MATERIAL_COEF_SAB              (LIST_DATA_SIZE + PARAM_N_COMMON + 115)
#define MATERIAL_BURN_FLUX_REL         (LIST_DATA_SIZE + PARAM_N_COMMON + 116)
#define MATERIAL_BURN_FLUX_AVE         (LIST_DATA_SIZE + PARAM_N_COMMON + 117)
#define MATERIAL_CI_BOS_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 118)
#define MATERIAL_CI_EOS_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 119)
#define MATERIAL_CI_AVE_ABSXS          (LIST_DATA_SIZE + PARAM_N_COMMON + 120)
#define MATERIAL_CI_BOS_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 121)
#define MATERIAL_CI_EOS_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 122)
#define MATERIAL_CI_AVE_ABSXS2         (LIST_DATA_SIZE + PARAM_N_COMMON + 123)
#define MATERIAL_CI_IDE                (LIST_DATA_SIZE + PARAM_N_COMMON + 124)
#define MATERIAL_PTR_DETBIN            (LIST_DATA_SIZE + PARAM_N_COMMON + 125)
#define MATERIAL_PTR_INFLOW            (LIST_DATA_SIZE + PARAM_N_COMMON + 126)
#define MATERIAL_PTR_OUTFLOW           (LIST_DATA_SIZE + PARAM_N_COMMON + 127)
#define MATERIAL_FLOW_IDX              (LIST_DATA_SIZE + PARAM_N_COMMON + 128)
#define MATERIAL_FLOW_N                (LIST_DATA_SIZE + PARAM_N_COMMON + 129)
#define MATERIAL_FLOW_PTR_FIRST        (LIST_DATA_SIZE + PARAM_N_COMMON + 130)
#define MATERIAL_PTR_ORIG_NUC_COMP     (LIST_DATA_SIZE + PARAM_N_COMMON + 131)
#define MATERIAL_PTR_DECAY_SRC         (LIST_DATA_SIZE + PARAM_N_COMMON + 132)
#define MATERIAL_PHOTON_ATT_NE         (LIST_DATA_SIZE + PARAM_N_COMMON + 133)
#define MATERIAL_PTR_PHOTON_ATT_E      (LIST_DATA_SIZE + PARAM_N_COMMON + 134)
#define MATERIAL_PTR_PHOTON_ATT_F      (LIST_DATA_SIZE + PARAM_N_COMMON + 135)
#define MATERIAL_SAMPLED_PHOTON_SRC    (LIST_DATA_SIZE + PARAM_N_COMMON + 136)
#define MATERIAL_MAX_ADENS             (LIST_DATA_SIZE + PARAM_N_COMMON + 137)
#define MATERIAL_PTR_TTB               (LIST_DATA_SIZE + PARAM_N_COMMON + 138)
...
#define NUCLIDE_BLOCK_SIZE             (LIST_DATA_SIZE + 93)
...
#define REACTION_PM149_YIELD            (LIST_DATA_SIZE + 50)
#define REACTION_SM149_YIELD            (LIST_DATA_SIZE + 51)
#define REACTION_MODE                   (LIST_DATA_SIZE + 52)
#define REACTION_PTR_MGXS               (LIST_DATA_SIZE + 53)
#define REACTION_PTR_URES_MAX           (LIST_DATA_SIZE + 54)
#define REACTION_URES_MAX_N0            (LIST_DATA_SIZE + 55)
#define REACTION_URES_MAX_NP            (LIST_DATA_SIZE + 56)
#define REACTION_SAB_MIN_EM_E           (LIST_DATA_SIZE + 57)
#define REACTION_SAB_MAX_EM_E           (LIST_DATA_SIZE + 58)
#define REACTION_CACHE_OPTI_IDX         (LIST_DATA_SIZE + 59)
#define REACTION_PTR_TMP_MAJORANT       (LIST_DATA_SIZE + 60)
#define REACTION_PTR_0K_DATA            (LIST_DATA_SIZE + 61)
#define REACTION_PTR_BRA_STATE          (LIST_DATA_SIZE + 62)
#define REACTION_PTR_BRA_ISOMER         (LIST_DATA_SIZE + 63)
#define REACTION_PTR_MULT               (LIST_DATA_SIZE + 64)
...
#define IFC_FUEP_LIST_BLOCK_SIZE       (LIST_DATA_SIZE + 24)
...
#define IFC_FUEP_PTR_FINIX             (LIST_DATA_SIZE + 23)
...
#define GCU_INF_FLX                    (LIST_DATA_SIZE + 191)
#define GCU_INF_MICRO_FLX              (LIST_DATA_SIZE + 192)
...
#define GCU_B1_KEFF                    (LIST_DATA_SIZE + 294)
#define GCU_B1_KINF                    (LIST_DATA_SIZE + 295)
#define GCU_B1_B2                      (LIST_DATA_SIZE + 296)
#define GCU_B1_ERR                     (LIST_DATA_SIZE + 297)
#define GCU_B1_FISS_FLX                (LIST_DATA_SIZE + 298)
#define GCU_B1_MICRO_FLX               (LIST_DATA_SIZE + 299)
