...
void ProcessPoisons()
{
  long mat, mat0, iso, nuc, ptr, add, rea, yld, ZA, TMS;
  double f;
  ...
  fprintf(out, "Setting fission product poison data...\n\n");
	      ...
	      if ((yld = (long)RDB[rea + REACTION_PTR_FISSY]) > VALID_PTR)
		{
		  ...
		  while (ptr > VALID_PTR)
		    {      
		      ...
		      /* Direct yields for Xe-135 and Sm-149 */
