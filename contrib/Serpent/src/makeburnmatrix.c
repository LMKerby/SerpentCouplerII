  ...
  while (iso > VALID_PTR)
    {
      ...
      StoreValuePair(nuc + NUCLIDE_PTR_MATRIX_IDX, (double)mat, i, id);
  ...
  if (((ZAI == 541350) || (ZAI == 942390) || (ZAI == 641550)
       || (ZAI == 922380) || (ZAI == 531310)) && (mt == 102))
    {
      ...
      fprintf(fp, "m%s%ld_mt%ld(%ld,%ld) = %1.5E;\n", 
	      ...
	      TestValuePair(rea + REACTION_PTR_TRANSMUXS, mat, id));
