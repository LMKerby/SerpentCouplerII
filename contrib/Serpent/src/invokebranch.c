  ...
  if ((f = RDB[loc0 + DEP_BRA_NORM]) >= 0.0)
      ...
      while (loc1 > VALID_PTR)
	{
	  ...
	  if (RDB[loc1 + NORM_POWER] > 0.0)
	    WDB[loc1 + NORM_POWER] = WDB[loc1 + NORM_POWER]*f;
	  else if (RDB[loc1 + NORM_POWDENS] > 0.0)
	    WDB[loc1 + NORM_POWDENS] = WDB[loc1 + NORM_POWDENS]*f;
	  else if (RDB[loc1 + NORM_GENRATE] > 0.0)
	    WDB[loc1 + NORM_GENRATE] = WDB[loc1 + NORM_GENRATE]*f;
	  else if (RDB[loc1 + NORM_FISSRATE] > 0.0)
	    WDB[loc1 + NORM_FISSRATE] = WDB[loc1 + NORM_FISSRATE]*f;
	  else if (RDB[loc1 + NORM_ABSRATE] > 0.0)
	    WDB[loc1 + NORM_ABSRATE] = WDB[loc1 + NORM_ABSRATE]*f;
	  else if (RDB[loc1 + NORM_LOSSRATE] > 0.0)
	    WDB[loc1 + NORM_LOSSRATE] = WDB[loc1 + NORM_LOSSRATE]*f;
	  else if (RDB[loc1 + NORM_FLUX] > 0.0)
	    WDB[loc1 + NORM_FLUX] = WDB[loc1 + NORM_FLUX]*f;
	  else if (RDB[loc1 + NORM_SRCRATE] > 0.0)
	    WDB[loc1 + NORM_SRCRATE] = WDB[loc1 + NORM_SRCRATE]*f;
	  else if (RDB[loc1 + NORM_SFRATE] > 0.0)
	    WDB[loc1 + NORM_SFRATE] = WDB[loc1 + NORM_SFRATE]*f;
