...
#ifdef DNPRINT
  fprintf(out, "%ld live neutrons reached the end of simulation\n", nlive);
  fprintf(out, "Mean weight was %E\n", Wlive/nlive);
#endif
...
#ifdef DNPRINT
  fprintf(out, "Live population was %E neutrons\n", Wlive*norm);
#endif
...
#ifdef DNPRINT
	fprintf(out, "Precursor population for group was %E precursors (list)\n", Wlist[j]*norm);
#endif
      }
